        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                  <h3 class="mb-3 text-white">Login Now (Admin)</h3>
                        ...
                        <div class="row">
                                    ...
                                    <Form @submit.prevent="submit"  class="row g-4">
                                            <div class="col-12">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <Field name="email" :rules="validateEmail" type="email" v-model="email" class="form-control" placeholder="Enter e-mail"/>
                                                </div>
                            ...
                            <div class="col-md-5 ps-0 d-none d-md-block">
                                <div class="form-right h-100 bg-dark text-white text-center pt-5">
                                    ...
                                    <h2 class="fs-1">ComSci Book Shop</h2>
                                </div>
                            </div>
                        </div>
                    </div>
...
import {ref} from 'vue'
//import { useFormRules } from '@/composables/userFormRules'
    ...
    if (error.value === null) {
      ...
      if (data.user_role==='admin'){
        ...
        Swal
          ...
          .then(async (result) => {
            if (result.dismiss === Swal.DismissReason.timer) {
              ...
              this.cookies.set("is_admin",true)
              this.cookies.set("userid",data.userId)
              this.cookies.set("email_abbrev",email.value.substring(0, 1).toUpperCase())
        ...
        Swal
          .fire({
            icon: "error",
            title: "คุณไม่มีสิทธิของผู้ดูแลระบบ",
            html: "กำลังเปลี่ยนไปยังหน้าผู้ใช้งานทั่วไป กรุณารอสักครู่ <b></b> วินาที",
            timer: 3000,
            timerProgressBar: true,
            didOpen: () => {
              Swal.showLoading();
